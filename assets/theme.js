...
var _MenuDisclosure = class extends CustomDetails {
  constructor() {
    super();
    /**
...
__publicField(CountdownTimerFlipDigit, "observedAttributes", ["number"]);
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (window.location.hash === "#shopify-product-reviews") {
        ...
        setTimeout(function() {
            var reviewButton = document.querySelector(".spr-summary-actions-newreview button");
